...
abstract: "Revisión general; añadidas pestañas con código R en cap. 6"
=======
...
Este libro no proporciona una formación de base en Excel, Python o R, aunque el código utilizado se explica con detalle y se indica la forma en la que se puede utilizar los diferentes modelos de IA para explicar y ayudar a comprender el código. El apéndice A detalla algunos recursos para este aprendizaje.
...
Todos los datos de los ejemplos están disponibles en hojas de cálculo y ficheros CSV, accesibles mediante enlaces directos en el texto desde el repositorio GitHub del libro. Al final se incluyen referencias y la bibliografía completa.
...
## Sobre este libro
Este libro se ha realizado utilizando [RStudio Desktop](https://posit.co/products/open-source/rstudio/)@rstudio y [Positron](https://posit.co/products/ide/positron/)@positron, y compilado con [Quarto](https://quarto.org/)@quarto, un conjunto de herramientas gratuitas y libres de [Posit](https://posit.co/). En la redacción y corrección de algunas partes del contenido se ha utilizado [Claude Sonnet 4.6](https://claude.ai/)@anthropic2025claude, de [Anthropic](https://www.anthropic.com/)
=======
