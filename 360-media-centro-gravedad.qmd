...
title: "La media aritmética como centro de gravedad de un grupo de datos"
engine: knitr
---
![Roldana tradicional romana](imagenes/220/roldana.jpg)
...
![Palanca de primer grado con el fulcro como punto de equilibrio](imagenes/220/palanca.jpeg){#fig-palanca}
...
::: {#fig-media-fulcro2 layout-ncol="2" layout-valign="bottom"}
![La media como punto de equilibrio](imagenes/070/media-balanza.svg){#fig-media}

![Palanca de primer grado](imagenes/070/palanca.webp){#fig-palanca}

Comparación gráfica del significado de la media en un diagrama de puntos (*dotplot*) con una palanca de primer grado, con el fulcro como punto de equilibrio.
:::

## Importancia del concepto de la media como centro de gravedad, y su comparación con la mediana.
