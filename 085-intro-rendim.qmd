...
En este ejemplo, vamos a suponer que elaboramos un queso de vaca, del que tenemos valores analíticos de producto terminado y de la leche utilizada en su elaboración. El proceso siempre tiene los mismos pasos tecnológicos, con la variabilidad que suponemos inherente.

Nuestros datos técnicos de fabricación están registraos en un fichero de datos en formato `csv`, que incluye:
...
En el recorrido de cálculo utilizaremos `Python`, aunque al final se proporciona una hoja de cálculo con la información necesaria.

El resultado analítico de nuestro producto elaborado es:
